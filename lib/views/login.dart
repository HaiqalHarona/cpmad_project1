                ...
                child: SingleChildScrollView(
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildTextField("Email", "Enter your email", Icons.email_outlined, emailController),
                      const SizedBox(height: 20),

                      _buildTextField("Password", "Enter your password", Icons.lock_outline, passwordController, isPassword: true),
                        ...
                        children: [
                          ...
                          TextButton(
                            ...
                            child: const Text("Forgot password?", 
                                style: TextStyle(color: Color(0xFF4E74F9), fontWeight: FontWeight.bold, fontSize: 13)),
                          ),
                        ],
                      ),
